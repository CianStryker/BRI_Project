                    ...
                    tabPanel(
                        ...
                        fluidRow(
                            ...
                            column(width = 8,
                                   ...
                                   tags$p("The regression above essentially demonstrates the same information from the box-and-whisker plots. While a positive relationship between GDP and FDI is still apparent, only the political rights category of 1 has a statistically significant, negative relationship and even then, it is weaker at only p = 0.05. No other category has a significant relationship. This adequately demonstrates that little relationship if any exists between Chinese investment and the political preferences of target countries. Potentially the negative relationship between category 1 countries and FDI signifies the preference of Chinese investors to avoid the most democratic countries within the BRI regions. One thing worth exploring, however, is geographically how did preferences change over time. ") 
                    ...
                    tabPanel(
                        ...
                        fluidRow(
                            ...
                            column(width = 6,
                                   ...
                                   HTML('<iframe width="100%" height="500" src="https://www.youtube.com/embed/cvlfV56kKKA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'),
