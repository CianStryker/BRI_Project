...
```{r, Directory Creating}

# I make my Shiny/Images directory here.

dir_create("China_and_BRI/Images")
```
...
dir_create("China_and_BRI/RDS_Files")

# Here I'm writing my data sets for the toggle graphs and
# the linear regressions as rds files to be put in my shiny
# directory.

write_rds(data7, path = "China_and_BRI/RDS_Files/data7.rds")
write_rds(linearMod10, path = "China_and_BRI/RDS_Files/linearMod10.rds")
write_rds(linearMod14, path = "China_and_BRI/RDS_Files/linearMod14.rds")
write_rds(data11, path = "China_and_BRI/RDS_Files/data11.rds")
...
# Just sending the pdf to Shiny.

file_copy("BRI_Project.pdf", "China_and_BRI/www")
```
