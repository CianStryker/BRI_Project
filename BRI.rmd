...
ggplot(test5, aes(x = y_cum4, size = y_cum4, color = region, y = GDP_Increase)) +
  ...
  geom_text(data = subset(test5, GDP_Increase > 1e+12 | y_cum4 > 25000), aes(label = country2, hjust = 1.3, vjust = -1)) +
...
ggplot(Map1x, aes( x = long, y = lat, group = group )) +
  ...
  labs(fill = 'Political Rights'
       ,title = 'Political Rights within the BRI Regions before Chinese Investment'
       ,subtitle = '2005'
       ,x = NULL
       ,y = NULL) +
  theme(text = element_text(family = 'Gill Sans', color = '#333333')
...
ggplot(Map2x, aes( x = long, y = lat, group = group )) +
  ...
  scale_fill_discrete() +
  labs(fill = 'Political Rights'
       ,title = 'Political Rights within the BRI Regions after Chinese Investment'
       ,subtitle = '2018'
       ,x = NULL
       ,y = NULL) +
  theme(text = element_text(family = 'Gill Sans', color = '#333333')
