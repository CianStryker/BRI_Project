...
ggplot(China_sector4y, aes(x = sector, y = FDI, fill = region)) +
  geom_col()+
  labs(x= "Sector", y= "Foreign Direct Investment", fill=NULL, title="Chinese BRI Investment per Year: {closest_state}") +
...
ggplot(trial2, aes(x = country2, y = FDI, size = FDI, color = region)) +
  geom_jitter()+
...
ggplot(trial2, aes(x = country, y = FDI, color = region)) +
  geom_point()+
